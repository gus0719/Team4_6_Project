...
function viewImg(contextPath){
    ...
    explain_top_mainImg.src = contextPath + "/resources/img" + imgArr[0];

    explain_top_subImg.innerHTML = "";
    explain_images.innerHTML = "";
    for(let i = 0; i < imgArr.length; i++){
        explain_top_subImg.innerHTML +=
        `<img class = "explain_top_subImg_dots" src = "${contextPath + "/resources/img" + imgArr[i]}">`;
        explain_images.innerHTML +=
        `<img src = "${contextPath + "/resources/img" + imgArr[i]}">`;
    }
}