...
<%@ page import = "sample.spring.dto.ShopBuyDTO" %>
...
<head>
    ...
    <title>주문완료</title>
    <link href="resources/css/shop_order.css" rel="stylesheet">
    <%
                    ...
                    <div class="white">
                        ...
                        <div class="buts">
                            <div class="leftt">
                                ...
                                <input type="button" class="shoping" value="쇼핑 계속하기" onclick = "location.href = '<%=contextPath%>/index'">
                            </div>
                        </div>
                    </div>
                </div>
