...
<head>
    ...
    <link rel = "stylesheet" href = "resources/css/shop_explain.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200">
    <script src = "resources/js/shop_explain.js"></script>
    <script src = "resources/js/shop_explain_wiki.js"></script>
    <%
    /* 상품 끌어오기 =========================================
    */
    ...
    <div id = "wrapper">
        <form method = "get" action = "<%=contextPath%>">
	        ...
	        <div id = "explain_top">
	            ...
	            <aside>
	                <div id = "explain_product">
	                    ...
	                    <div id = "product_buy" onclick = "goToBuyPage('<%=contextPath%>')">구매</div><%--클릭 시 상품 정보들을 hidden에 담아서 구매페이지로 서밋--%>
	                    <div id = "product_cart" onclick = "putItemOnCart('<%=contextPath%>')">장바구니</div>
	        ...
	        <div id = "explain_wiki">
	            ...
	            <span id = "updateWikiBtn" onclick = "updateWiki('<%=contextPath%>')">변경</span><%--클릭 시 상품코드, 상품명, 위키텍스트를 hidden에 담아서 wiki_pro 페이지로 서밋--%>
	            <%
	            }
	            %>
	        </div>
