...
<%@ page import = "sample.spring.dto.ShopCartDTO"%>
    ...
    <main id = "wrapper">
        ...
        <form method = "get">
            ...
            <div id="cart">
                ...
                %>
                    <li>
                        <img onclick = "goExplain(<%= productDTO.getProduct_code()%>, '<%= msg%>')" src = "resources/img<%=imgArr[0]%>">
                        ...
                        %>
                        <span id = "cartDel" class = "material-symbols-outlined" onclick = "deleteItem('<%=contextPath%>', <%= productDTO.getProduct_code()%>)">delete</span>
                    </li>
                <%
                }
                %>
