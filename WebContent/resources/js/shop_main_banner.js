...
const bannerImgArr = [
    ["/resources/img/banner/main_banner1.webp", "shoe", ""],
    ["/resources/img/banner/main_banner2.jpg", "shirt", "supreme"],
    ["/resources/img/banner/main_banner3.webp", "phone", ""],
    ["/resources/img/banner/main_banner4.webp", "shoe", "나이키"],
    ["/resources/img/banner/main_banner5.webp", "watch", ""]
];
...
function bannerInit(path){
    ...
    bannerImg.src = prjPath + bannerImgArr[idx][0];
...
function bannerClick(idx) {
	...
	document.forms[1].action = prjPath + "/category";
