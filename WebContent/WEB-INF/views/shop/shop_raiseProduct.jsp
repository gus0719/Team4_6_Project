...
<head>
    <meta charset="UTF-8">
    <title>상품등록</title>
    <link rel = "stylesheet" href = "resources/css/shop_raiseProduct.css">
    <link rel = "stylesheet" href = "resources/css/shop_explain.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@20..48,100..700,0..1,-50..200">
    <script src = "resources/js/shop_raiseProduct.js"></script>
    <script src = "resources/js/shop_explain.js"></script>
</head>
<body style = "overflow-x : hidden">
    <div id="container">
        <img id = "logo" src = "resources/img/logo.png" onclick = "location.href = '<%=contextPath%>/index'">
        <p id = "title">상품 등록</p>
        <form method = "post" action = "<%=contextPath%>/raiseProduct">
            <table>
                <colgroup>
                ...
                <tr>
                    ...
                    <td class = "inputs">
                        <input type = "file" id = "product_img" multiple onchange = "getImages(), viewImg('<%=contextPath%>')" alt = "pd_img.value"
                        required = "required">
