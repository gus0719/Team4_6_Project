...
<%@ page import="sample.spring.dto.ShopProductDTO"%>
...
<link href="resources/css/shop_buy.css" rel="stylesheet" type="text/css">
<%
/* 로그인 확인 ===========================
*/
...
if(user_id == null){ // 로그인 상태 아니면 로그인 페이지로 이동
	...
	response.sendRedirect(contextPath+"/login?msg="+URLEncoder.encode(msg, "utf-8"));
} else {
...
<body>
   <div id="__nuxt">
   <img src = "resources/img/logo.png" id = "logo" onclick = "alert('구매 취소'), setTimeout(location.href = '<%=contextPath%>/index', 2000)">
                                ...
                                <div class="product_info">
                                    <div class="product" >
                                        ...
                                        <picture class="picture product_img">
                                            <img alt="상품 이미지" class="image full_width" src="resources/img<%=mainImg%>">
                                        </picture><!----><!----><!---->
                                    </div>
                                    ...
                                    <div class="section_content"><!-- 배송방법-->
                                        <div class="delivery_service_option selected">
                                            <div class="delivery_way">
                                                <div class="way_info">
                                                    <div class="way-status-thumbnail"><img src="resources/img/icon/box1.png"
                                        ...
                                        <div class="delivery_service_option">
                                            <div class="delivery_way">
                                                <div class="way_info">
                                                    <div class="way-status-thumbnail"><img src="resources/img/icon/chango.png"
                                                ...
                                                <div class="pay_method md">
                                                    ...
                                                    <div class="pay_item naverpay">
                                                        <div class="pay_box">
                                                            <div class="pay_title">
                                                                ...
                                                                <!---->
                                                            </div><img src="resources/img/payment/npay.png" alt="네이버페이" class="pay_img">
                                                        </div>
                                                    </div>
                                                    <div class="pay_item kakaopay">
                                                        <div class="pay_box">
                                                            <div class="pay_title">
                                                                ...
                                                                <!---->
                                                            </div><img src="resources/img/payment/kakaopay.png" alt="카카오페이"
                                                                class="pay_img">
                                                        </div>
                                                    </div>
                                                    <div class="pay_item tosspay">
                                                        <div class="pay_box">
                                                            ...
                                                            </div><img src="resources/img/payment/toss.png" alt="토스페이" class="pay_img">
                                                        </div>
                                                    </div>
                                                    <div class="pay_item payco">
                                                        <div class="pay_box">
                                                            ...
                                                            </div><img src="resources/img/payment/payco.png" alt="페이코" class="pay_img">
                                                        </div>
                                                    </div>
                                                </div>
