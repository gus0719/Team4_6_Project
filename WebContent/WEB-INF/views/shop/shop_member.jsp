<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  String phone = request.getParameter("shop_phone");
	...
	//control
	String realPath = contextPath + "/register";
	//css
	String cssPath = contextPath + "/resources/css/shop_member.css";
	//javaScript
	String javaScriptPath = contextPath + "/resources/js/shop_member.js";
	//img
